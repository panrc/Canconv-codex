...
class LAGConv2D(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride=1, padding=0, dilation=1, groups=1, use_bias=True):
        ...
        self.attention1 = nn.Sequential(
            nn.Conv2d(in_planes, kernel_size ** 2,
        ...
        conv1 = nn.Conv2d(in_planes, out_planes, kernel_size,
    ...
    def forward(self, x):
        ...
        kx = F.unfold(x, kernel_size=k, stride=self.stride,
                      padding=self.padding)  # b,n*k*k,n_H*n_W
